...
```gradle
dependencies {
    implementation 'com.github.apiverve:randomjoke-api:1.1.12'
}
```
...
```java
import com.apiverve.randomjoke.RandomJokeAPIClient;
import com.apiverve.randomjoke.APIResponse;
import com.apiverve.randomjoke.APIException;

// Initialize the client
RandomJokeAPIClient client = new RandomJokeAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randomjoke](https://docs.apiverve.com/ref/randomjoke)
...
- **Documentation:** [https://docs.apiverve.com/ref/randomjoke](https://docs.apiverve.com/ref/randomjoke)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randomjoke-api/issues)
