...
namespace APIVerve.Examples
{
    class RandomJokeExample
    {
        ...
        {
            Console.WriteLine("📤 Calling Random Joke API...\n");

            var result = await CallRandomJokeAPI();
